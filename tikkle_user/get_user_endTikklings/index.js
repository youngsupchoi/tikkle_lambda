...
exports.get_user_endTikklings = async (req, res) => {
	...
	try {
		const rows = await queryDatabase(
			`SELECT tikkling.id AS tikkling_id, tikkling.user_id, tikkling.type AS tikkling_type, tikkling.funding_limit, tikkling.created_at, tikkling.tikkle_quantity, tikkling.terminated_at, tikkling.product_id, tikkling.terminated_at,
